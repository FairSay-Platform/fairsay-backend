...
CREATE TABLE `complaint_reports` (
  ...
  CONSTRAINT `complaint_reports_ibfk_1` FOREIGN KEY (`complaint_id`) REFERENCES `complaints` (`id`),
  CONSTRAINT `complaint_reports_ibfk_2` FOREIGN KEY (`investigator_id`) REFERENCES `users` (`id`)
...
INSERT INTO `complaint_reports` VALUES (1,1,3,'Investigation completed. Evidence confirmed. Complaint resolved.','2026-03-03 15:12:43');
...
-- Dump completed on 2026-03-05 15:39:46
